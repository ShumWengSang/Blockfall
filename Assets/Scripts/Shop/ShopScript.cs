...
public class ShopScript : MonoBehaviour, IStoreListener
{
    ...
    public void Awake()
    {
        ...
        builder.AddProduct("com.GameGame.BlockFall.Powerup1", ProductType.Consumable, new IDs
		{
			{"com.GameGame.BlockFall.Powerup1.mac", MacAppStore.Name},
		});

        builder.AddProduct("com.GameGame.BlockFall.Powerup2", ProductType.Consumable, new IDs
		{
			{"com.GameGame.BlockFall.Powerup2.mac", MacAppStore.Name},
		});

        builder.AddProduct("com.GameGame.BlockFall.Powerup3", ProductType.Consumable, new IDs
		{
			{"com.GameGame.BlockFall.Powerup3.mac", MacAppStore.Name}
		});

        builder.AddProduct("com.GameGame.BlockFall.Powerup4", ProductType.Consumable, new IDs
		{
			{"com.GameGame.BlockFall.Powerup4.mac", MacAppStore.Name}
		});
